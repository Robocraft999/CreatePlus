...
public class CPItems {
	...
	private static RegistryObject<Item> registerGoggleModule(Item.Properties properties){
		if (ModCompat.MEKANISM.isLoaded()) {
			return ITEM_REGISTER.register("module_goggle_unit", () -> MekanismAPI.getModuleHelper().createModuleItem((IModuleDataProvider) CPModules.GOGGLE_MODULE::get, properties));
		}
		return null;
	}
