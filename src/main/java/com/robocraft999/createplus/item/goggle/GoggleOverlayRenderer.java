...
public class GoggleOverlayRenderer {
	...
	public static Supplier<Boolean> customGogglePredicate = () -> false;
	...
	public static Supplier<Boolean> getCustomGogglePredicate() {
		return customGogglePredicate;
	}
	
	/*
	public static void renderOverlayy(MatrixStack ms, IRenderTypeBuffer buffer, int light, int overlay,
		float partialTicks) {
	...
	/*
	public static void renderOverlayyy(MatrixStack ms, IRenderTypeBuffer buffer, int light, int overlay, float partialTicks) {
